...
<section class="section-padding gray-bg">
  <div class="container">
    ...
    <input type="text" style="display:none" name ="model" value="turbo">
    <div style="margin-left:-40px;" class="customization">
        <div class="color-options">
            <h2>Car Color</h2>
            <label>
                <input type="radio" name="car-color" value="white" checked>
                <img src="images/ttc1/white.png" alt="White">
            </label>
            <label>
                <input type="radio" name="car-color" value="black">
                <img src="images/ttc1/black.png" alt="Black">
            </label>
            <label>
                <input type="radio" name="car-color" value="red">
                <img src="images/ttc1/red.png" alt="Red">
            </label>
        </div>

        <div class="car-preview">
        <img src="images/ttc1/carwhite.jpg" alt="Car Preview">
        </div>
     ...
     <div class="wheel-options">
            ...
            <label>
                ...
                <img src="images/ttc1/wheel1.jpg" alt="Alloy Wheel 1">
            </label>
            <label>
                <input type="radio" name="alloy-wheel" value="2">
                <img src="images/ttc1/wheel2.jpg" alt="Alloy Wheel 2">
            </label>
            <label>
                <input type="radio" name="alloy-wheel" value="3">
                <img src="images/ttc1/wheel3.jpg" alt="Alloy Wheel 3">
            </label>
        </div>
    </div>
...
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="model">Login For Requesting</a>
    ...
    <script>
        ...
        function updateCarPreview() {
            ...
            let carImageUrl = `images/ttc1/carwhite.jpg`; // Default white car image

            if (selectedColor !== 'white' && selectedWheel) {
                carImageUrl = `images/ttc1/car${selectedColor}wheel${selectedWheel}.jpg`;
            }
            ...
            {
                carImageUrl = `images/ttc1/car${selectedColor}.jpg`;
            }
