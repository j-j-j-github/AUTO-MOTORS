  ...
  <div class="container">
    ...
    <div class="row"> 
      ...
      <div class="tab-content">
        <div style="display:grid; grid-template-columns: repeat(2, 1fr); gap: 3rem;" role="tabpanel" class="tab-pane active" id="resentnewcar">
...
<div style="height:100%;" class="recent-car-list">
